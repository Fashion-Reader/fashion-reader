...
class PerformanceRecorder():
    ...
    def __init__(self,
        ...
        self.best_record_filepath = os.path.join(
            '/'.join(self.record_dir.split('/')[:-1]), 'train_best_record.csv')
    ...
    def add_row(self,
        ...
        row = self.key_column_value_list + \
            [epoch_index, train_loss, validation_loss, train_score, validation_score]
    ...
    def plot_performance(self,
        ...
        plt.plot(epoch_range, train_history,
                 marker='.', c='red', label="train")
        plt.plot(epoch_range, validation_history,
                 marker='.', c='blue', label="validation")
