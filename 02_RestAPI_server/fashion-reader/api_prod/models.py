...
class Prods(models.Model):
    ...
    prod_id = models.CharField(max_length=128)
    prod_name = models.CharField(max_length=128)
    url = models.CharField(max_length=1024)
    item_type = models.CharField(max_length=1024)
...
class Product(models.Model):
    ...
    item_type_id = models.IntegerField(blank=True, null=True)
    price = models.CharField(max_length=10, blank=True, null=True)
    size_options = models.CharField(max_length=100, blank=True, null=True)
    color_options = models.CharField(max_length=100, blank=True, null=True)
    item_img_links = models.CharField(max_length=500, blank=True, null=True)
    thickness = models.CharField(max_length=30, blank=True, null=True)
    see_through = models.CharField(max_length=30, blank=True, null=True)
    flexibility = models.CharField(max_length=30, blank=True, null=True)
    touch = models.CharField(max_length=30, blank=True, null=True)
    fit = models.CharField(max_length=30, blank=True, null=True)
    lining = models.CharField(max_length=30, blank=True, null=True)
